...
'''
        ...
        self.assertEqual(func.gameDateFromText(text), '09-04-2023')
...
45.Nxc6 Bd7 46.Nd4 Nxb2 47.Kf3 Nd3 48.g3 Nc1 49.Ke3  1/2-1/2
'''
       self.assertEqual(func.gameWinnerFromText(text), 'Draw')
...
45.Nxc6 Bd7 46.Nd4 Nxb2 47.Kf3 Nd3 48.g3 Nc1 49.Ke3  1/2-1/2
'''
        self.assertEqual(func.gameDifferenceFromText(text), "White is 7.0 better than Black")
...
45.Nxc6 Bd7 46.Nd4 Nxb2 47.Kf3 Nd3 48.g3 Nc1 49.Ke3  1/2-1/2
'''
        self.assertEqual(func.gameMovesFromText(text), 49)
